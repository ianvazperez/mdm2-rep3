...
plot(DaysArr, TotArr, '-xr')
hold on
plot(DaysArr, Totf3, 'k--')
grid on
title('3rd order fit')

subplot(2,2,4)
plot(DaysArr, log(TotArr), '-xr')
hold on
plot(DaysArr, Totf4, 'k--')
grid on
title('Log fit')
...
plot(WeekDaysArr, WeekTotArr, '-xr')
hold on
plot(WeekDaysArr, WeekDaysf3, 'k--')
grid on
title('3rd order fit')

subplot(2,2,4)
plot(WeekDaysArr, log(WeekTotArr), '-xr')
hold on
plot(WeekDaysArr, WeekDaysf4, 'k--')
grid on
title('Log fit')
